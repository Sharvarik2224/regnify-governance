...
const categories = [
  ...
  },
  {
    ...
    bgColor: "bg-destructive/5 border-destructive/20",
    items: [
      { title: "Jordan Smith — AI vs Manager Conflict", desc: "Manager recommended CONFIRM but AI risk score is 72 (HIGH). Override justification pending." },
      { title: "Alice Johnson — Policy Deviation", desc: "AI recommends extended monitoring but manager submitted final approval." },
    ],
  },
  {
